...
\section{Communication Mechanisms}
	...
	\subsection{Java RMI}
		...
		\begin{itemize}
			...
			\item \textbf{Server}: implementa la risorsa remota (che sarà invocato dal client);
		...
		\end{itemize}
		Il \textbf{Registro}: è servizio di \textbf{naming} che mappa i nomi simbolici degli oggetti remoti al loro stub. Il Server può registrare un oggetto remoto nel registro scrivendone il nome e l'indirizzo al quale è reperibile. Il client cerca l'oggetto remoto all'interno del registro.\\
